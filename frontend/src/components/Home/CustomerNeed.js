...
const CustomerNeed = () => {
  ...
  useEffect(() => {
    const setImageSize = () => {
      ...
      image.src =
        "https://ik.imagekit.io/aq3ybtarw/gauge/water-purifier.webp?updatedAt=1680328546981";
    };
  ...
  function scrollToNextSection() {
    const nextSection = document.querySelector("#pure");
    if (nextSection) {
  ...
  return (
    <section id="next-section" className="text-gray-600 body-font">
      <div className="container mx-auto flex lg:px-28  pt-10  xl:flex-row flex-col-reverse   px-4 mb-3 lg:mb-6">
        <div className="lg:flex-grow md:w-6/2 lg:w-full lg:pr-4 md:pr-0 flex flex-col md:items-start md:text-left mb-16 md:mb-0  text-start lg:mx-auto">
          ...
          <button
            ...
            className="rt-arrow-btn rounded-full bg-blue-500 w-fit  lg:px-12 px-10 lg:py-5 py-5 flex m-auto mt-6 lg:mt-7 md:mb-14"
          >
            <a
        ...
        <div
          className="container mx-auto lg:px-20 lg:pt-20 pt-10"
          style={{ height: containerHeight }} // set the height of the container
        >
          <div className="lg:w-full w-full  ">
            <img
              ...
              alt="customer-need"
              src={`https://ik.imagekit.io/aq3ybtarw/gauge/water-purifier.webp?tr=w-${imageWidth},h-${imageHeight},fo-auto&iupdatedAt=1680328546981`}
              width={imageWidth}
              height={imageHeight}
              loading="lazy"
              onLoad={() => setImageLoaded(true)} // update the imageLoaded state variable once the image has loaded
            />
          </div>
        </div>
      </div>
