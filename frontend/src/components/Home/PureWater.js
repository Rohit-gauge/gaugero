          ...
          <div className="save-info-wrap flex mt-6 ">
            ...
            <div className="check-point">
              <p className="px-4">
                ...
                Monitor the daily amount of water that is filtered and wasted on
                your mobile phone. Also check TDS, flow rate, filters status.
              </p>
            </div>
          </div>
          <div className="save-info-wrap flex mt-6 ">
            ...
            <div className="check-point">
              <p className="px-4">
                <span className="font-bold">Auto-Troubleshooting:</span> India’s
                only water purifier that can automatically detect choking of
                filters and run troubleshooting programs to keep the water clean
                and bacteria free without any manual intervention.
              </p>
            </div>
          </div>
          <button
